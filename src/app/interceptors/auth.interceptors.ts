...
// This function will be used to intercept the Http Requests(CRUD) and add the accessToken in the header of the request if it is available in the cookie. 
...
export function authInterceptor(req: HttpRequest<unknown>, next: HttpHandlerFn){
    ...
    // when jwtToken(accessToken present in cookie) is expired then we send error
